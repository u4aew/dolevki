...
*   @link     http://yupe.ru
**/
class RealtyPageBackendController extends \yupe\components\controllers\BackController
{
    /**
    ...
    */
    ...
    {
        $model = new RealtyPage;

        if (Yii::app()->getRequest()->getPost('RealtyPage') !== null) {
            $model->setAttributes(Yii::app()->getRequest()->getPost('RealtyPage'));
    ...
    */
    ...
    {
        $model = new RealtyPage('search');
        $model->unsetAttributes(); // clear any default values
        if (Yii::app()->getRequest()->getParam('RealtyPage') !== null)
            $model->setAttributes(Yii::app()->getRequest()->getParam('RealtyPage'));
    ...
    */
    ...
    {
        $model = RealtyPage::model()->findByPk($id);
        if ($model === null)
